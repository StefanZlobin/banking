...
class DetailedCalculationMortgagePage extends StatelessWidget {
  const DetailedCalculationMortgagePage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Детальная страница расчета ипотеки'),
      ),
