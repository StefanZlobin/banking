...
class CreditCalcButton extends StatelessWidget {
  const CreditCalcButton({super.key});
                ...
                onPressed: () {
                  getIt<DetailedCalculationBloc>().add(
                    DetailedCalculationEvent.onCalculate(
                      ...
                      creditType: CreditTypeEnum.credit,
                    ),
                  );
                  context.push(
                      AppRoutesEnum.detailedCalculationCredit.routeToPath);
                },
